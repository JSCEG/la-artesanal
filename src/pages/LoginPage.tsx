      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/85 backdrop-blur-2xl rounded-[2rem] p-8 md:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.25)] border border-white/60">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="font-display text-3xl font-black text-brand-wood">La Artesanal</h1>
            <p className="text-sm text-brand-wood-soft mt-1 font-medium">Bienvenido de vuelta</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@laartesanal.mx"
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-brand-wood/10 text-center">
            <p className="text-sm text-brand-wood-soft">
              ¿Nuevo por aquí?{' '}
              <Link to="/registro" className="font-bold text-brand-berry hover:text-brand-berry-soft transition-colors">
                Crea tu cuenta
              </Link>
            </p>
          </div>
